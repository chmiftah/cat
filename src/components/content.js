...
const Content = ({ title }) => (
  <div className="flex flex-col flex-wrap sm:flex-row">
    <div className=" w-full  px-2 mb-12">
      <div className=" rounded-lg shadow   bg-white p-10">
        <div className="mb-8">
          <span className="text-5xl font-medium">Welcome Back, </span><span className="font-bold text-5xl text-blue-500">Miftah!</span>
        </div>
        <div className="my-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-4">
            <div className="p-8 bg-indigo-500 rounded-lg shadow-lg flex ">
              <div className="p-12 mr-6 bg-gray-200 rounded-lg">
              </div>
              <div >
                <p className="text-white text-xl font-thin" >Jumlah Paket SKD Tersedia</p>
                <p className="text-3xl my-1 font-medium text-white">100</p>
              </div>
            </div>
            <div className="p-8 bg-indigo-500 rounded-lg shadow-lg flex ">
              <div className="p-12 mr-6 bg-gray-200 rounded-lg">
              ...
              <div >
                <p className="text-white text-xl font-thin" >Jumlah Paket SKB Tersedia</p>
                <p className="text-3xl my-1 font-medium text-white">100</p>
              </div>
            </div>
            <div className="p-8 bg-indigo-500 rounded-lg shadow-lg flex ">
              ...
              <div >
                <p className="text-white text-xl font-thin" >Jumlah Paket TIU Tersedia</p>
                <p className="text-3xl my-1 font-medium text-white">100</p>
              </div>
            </div>
            <div className="p-8 bg-indigo-500 rounded-lg shadow-lg flex ">
              ...
              <div >
                <p className="text-white text-xl font-thin" >Jumlah Paket TWK Tersedia</p>
                <p className="text-3xl my-1 font-medium text-white">100</p>
              </div>
            </div>
          </div>
    ...
    <div className="w-full md:w-4/12 md:px-2 mb-6 md:mb-0">
      <div className="shadow-lg rounded-2xl bg-indigo-500 dark:bg-gray-800 p-4">
        <div className="flex text-white  items-center justify-between">
          <p className="text-4xl font-medium mb-4">Paket Lanjutan</p>
